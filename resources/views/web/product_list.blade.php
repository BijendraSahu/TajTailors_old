    ...
    <script type="text/javascript">
            ...
            */
            ...
            IonRangeSlider.prototype = {
                ...
                prettify: function (num) {
                    ...
                    return n.replace(/(\d{1,1}(?=(?:\d\d\d)+(?!\d)))/g, "$1" + this.options.prettify_separator);
                },
                ...
                update: function (options) {
                    ...
                    /*this.update_check.from =  parseFloat(this.result.from.replace(/([^0-9\.])/g, ''));
                     this.update_check.to = parseFloat(this.result.to.replace(/([^0-9\.])/g, ''));*/
        ...
        $(function () {
            ...
            $inputFrom.on("input", function () {
                ...
                /* var price = $('.irs-from').text();
                 var parsedPrice = parseFloat(price.replace(/([^0-9\.])/g, ''));
                 $('.irs-from').text(parsedPrice);*/
            });
            ...
            $inputTo.on("input", function () {
                ...
                /*  var price = $('.irs-to').text();
                 var parsedPrice = parseFloat(price.replace(/([^0-9\.])/g, ''));
                 $('.irs-to').text(parsedPrice);*/
            });
...
@section('content')
    ...
    <script>
        ...
        function getMinMaxItems() {
            var category_id = $('#category_id').val() == '' ? '0' : $('#category_id').val();
            ...
            $.ajax({
                ...
                url: "{{ url('getPriceproducts') }}",
                data: {currentpage: limit, category_id: category_id, min_price: min_price, max_price: max_price},
                beforeSend: function () {
