                    ...
                    <div class="product_details_containner">
                        <div class="product_magnifyimages_box" id="product_details_containner">
                            <div class="magnify">
                                ...
                                @if(count($item_images)>0)
                                    <img class="small" src="{{url('p_img').'/'.$item->id.'/'.$item_images[0]->image}}">
                                @else
                                    <img class="small" id="view_images" src="{{url('images/potato.jpg')}}"/>
                                @endif
                        ...
                        <div class="more_productother_details">
                            ...
                            <div class="option_availability">
                                ...
                                <div class="option_txt">{!! $item->specifcation!!}</div>
                            </div>
                            {{-- <div class="option_availability">
                                ...
                                <div class="review-block">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="review-block-title">क्यों न खाएं बेहतर जब मिले उसी दाम में ।
                                            </div>
